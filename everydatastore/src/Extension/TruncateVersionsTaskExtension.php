 ...
 */
class TruncateVersionsTaskExtension extends BuildTask
{
    /**
     * URL segment
     *
     * @var string
     */
    private static $segment = 'TruncateVersionsTaskExtension';
     ...
     * @var string
     */
    protected $title = 'EveryDataStore: Prune old DataObject versions';
     ...
     * @var string
     */
    protected $description = 'Delete old versioned DataObject versions from the database, only cron member could run this Task';
    ...
    public function run($request) {
        ...
        if (!Director::is_cli() && !EveryDataStoreHelper::getMember()) {
